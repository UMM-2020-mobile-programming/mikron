...
import id.neilsama.mikron.adapter.CustomAdapter;
...
public class ChatFragment extends Fragment {
    ...
    int [] icon = {R.drawable.baseline_account_circle_black_24dp, R.drawable.baseline_account_circle_black_24dp,R.drawable.baseline_account_circle_black_24dp};
    String [] judul = {"Mikron Users","Mikron Users","Mikron Users"};
    String [] deskripsi = {"Isi Chat","Isi Chat","Isi Chat"};
